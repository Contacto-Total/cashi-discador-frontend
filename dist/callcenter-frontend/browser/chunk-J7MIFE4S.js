...
var _c02 = (a0) => ["/contacts", a0, "edit"];
function ContactListComponent_th_98_Template(rf, ctx) {
  if (rf & 1) {
...
function ContactListComponent_td_99_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", contact_r1.firstName, " ", contact_r1.lastName, " ");
  }
}
function ContactListComponent_th_101_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 54);
...
function ContactListComponent_td_102_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 55);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(contact_r2.phoneNumber);
  }
}
function ContactListComponent_th_104_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 54);
    \u0275\u0275text(1, "Email");
    \u0275\u0275elementEnd();
...
function ContactListComponent_td_105_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 55);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(contact_r3.email || "N/A");
  }
}
function ContactListComponent_th_107_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 54);
    \u0275\u0275text(1, "Estado");
    \u0275\u0275elementEnd();
...
function ContactListComponent_td_108_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMap("status-chip " + ctx_r4.getStatusClass(contact_r4.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r4.getStatusLabel(contact_r4.status), " ");
  }
}
function ContactListComponent_th_110_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 54);
    \u0275\u0275text(1, "Intentos");
    \u0275\u0275elementEnd();
...
function ContactListComponent_td_111_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 55);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(contact_r6.attempts || 0);
  }
}
function ContactListComponent_th_113_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 54);
    \u0275\u0275text(1, "Acciones");
    \u0275\u0275elementEnd();
...
function ContactListComponent_td_114_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContactListComponent_td_114_Template_button_click_3_listener() {
      const contact_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.callContact(contact_r8));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c02, contact_r8.id));
    \u0275\u0275advance();
    \u0275\u0275property("size", 18);
    \u0275\u0275advance(2);
    \u0275\u0275property("size", 18);
...
function ContactListComponent_tr_115_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 60);
  }
}
function ContactListComponent_tr_116_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 61);
  }
}
function ContactListComponent_div_117_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62);
    \u0275\u0275element(1, "lucide-angular", 4);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "No hay contactos registrados");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 63);
    \u0275\u0275element(5, "lucide-angular", 23);
    \u0275\u0275text(6, " Agregar Primer Contacto ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
var _ContactListComponent = class _ContactListComponent {
  constructor(contactService, authService, themeService) {
    this.contactService = contactService;
    this.authService = authService;
    this.themeService = themeService;
    this.contacts = [];
    this.displayedColumns = ["name", "phone", "email", "status", "attempts", "actions"];
...
_ContactListComponent.\u0275fac = function ContactListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ContactListComponent)(\u0275\u0275directiveInject(ContactService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ThemeService));
};
_ContactListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactListComponent, selectors: [["app-contact-list"]], decls: 118, vars: 21, consts: [[1, "contacts-container"], [1, "header"], [1, "header-left"], [1, "app-icon"], ["name", "user", 3, "size"], [1, "header-info"], [1, "subtitle"], [1, "advisor-info"], [1, "label"], [1, "name"], [1, "header-right"], ["mat-raised-button", "", 1, "theme-toggle", 3, "click"], [3, "name", "size"], [1, "status-section"], [1, "status-label"], [1, "status-value", "available"], [1, "timer"], [1, "time"], [1, "info-bar"], [1, "info-data"], [1, "value"], [1, "action-buttons"], ["mat-raised-button", "", "routerLink", "/contacts/new", 1, "btn-add"], ["name", "plus", 3, "size"], ["mat-raised-button", "", "routerLink", "/dialer", 1, "btn-back"], ["name", "arrow-left", 3, "size"], [1, "main-content"], [1, "left-panel"], [1, "filter-tabs"], ["label", "\u{1F50D} Filtros"], [1, "tab-content"], [1, "section"], [1, "section-title"], [1, "filter-option"], [1, "stat-item"], [1, "stat-label"], [1, "stat-value"], [1, "right-panel"], [1, "list-section"], [1, "section-header"], ["name", "list", 3, "size"], [1, "table-container"], ["mat-table", "", 1, "contacts-table", 3, "dataSource"], ["matColumnDef", "name"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "phone"], ["matColumnDef", "email"], ["matColumnDef", "status"], ["matColumnDef", "attempts"], ["matColumnDef", "actions"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", "class", "table-row", 4, "matRowDef", "matRowDefColumns"], ["class", "no-data", 4, "ngIf"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-icon-button", "", 1, "action-btn", 3, "routerLink"], ["name", "edit", 3, "size"], ["mat-icon-button", "", 1, "action-btn", "call-btn", 3, "click"], ["name", "phone-call", 3, "size"], ["mat-header-row", ""], ["mat-row", "", 1, "table-row"], [1, "no-data"], ["mat-raised-button", "", "color", "primary", "routerLink", "/contacts/new"]], template: function ContactListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "div", 2)(3, "div", 3);
    \u0275\u0275element(4, "lucide-angular", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 5)(6, "h1");
    \u0275\u0275text(7, "Gesti\xF3n de Cobranza");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 6);
    \u0275\u0275text(9, "\u{1F4CB} Gesti\xF3n de Contactos");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function ContactListComponent_Template_button_click_16_listener() {
      return ctx.toggleTheme();
    });
    \u0275\u0275element(17, "lucide-angular", 12);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(23, " \u26AA DISPONIBLE ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 16)(25, "span", 17);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(27, "div", 18)(28, "div", 19)(29, "span", 8);
    \u0275\u0275text(30, "\u2726 TOTAL CONTACTOS");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 20);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 19)(34, "span", 8);
    \u0275\u0275text(35, "Nuevos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 20);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 19)(39, "span", 8);
    \u0275\u0275text(40, "En Proceso");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "span", 20);
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "div", 19)(44, "span", 8);
    \u0275\u0275text(45, "Contactados");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 20);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 21)(49, "button", 22);
    \u0275\u0275element(50, "lucide-angular", 23);
    \u0275\u0275text(51, " Nuevo Contacto ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "button", 24);
    \u0275\u0275element(53, "lucide-angular", 25);
    \u0275\u0275text(54, " Volver a Softphone ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 26)(56, "aside", 27)(57, "mat-tab-group", 28)(58, "mat-tab", 29)(59, "div", 30)(60, "div", 31)(61, "h3", 32);
    \u0275\u0275text(62, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "div", 33)(64, "label");
    \u0275\u0275text(65, "Todos los estados");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(66, "div", 31)(67, "h3", 32);
    \u0275\u0275text(68, "\u{1F4CA} Estad\xEDsticas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "div", 34)(70, "span", 35);
    \u0275\u0275text(71, "Total:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "span", 36);
    \u0275\u0275text(83);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 34)(85, "span", 35);
    \u0275\u0275text(86, "Contactados:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "span", 36);
    \u0275\u0275text(88);
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(89, "main", 37)(90, "div", 38)(91, "div", 39);
    \u0275\u0275element(92, "lucide-angular", 40);
    \u0275\u0275elementStart(93, "h3");
    \u0275\u0275text(94, "Lista de Contactos");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(95, "div", 41)(96, "table", 42);
    \u0275\u0275elementContainerStart(97, 43);
    \u0275\u0275template(98, ContactListComponent_th_98_Template, 2, 0, "th", 44)(99, ContactListComponent_td_99_Template, 2, 2, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(100, 46);
    \u0275\u0275template(101, ContactListComponent_th_101_Template, 2, 0, "th", 44)(102, ContactListComponent_td_102_Template, 2, 1, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(103, 47);
    \u0275\u0275template(104, ContactListComponent_th_104_Template, 2, 0, "th", 44)(105, ContactListComponent_td_105_Template, 2, 1, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(106, 48);
    \u0275\u0275template(107, ContactListComponent_th_107_Template, 2, 0, "th", 44)(108, ContactListComponent_td_108_Template, 3, 3, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(109, 49);
    \u0275\u0275template(110, ContactListComponent_th_110_Template, 2, 0, "th", 44)(111, ContactListComponent_td_111_Template, 2, 1, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(112, 50);
    \u0275\u0275template(113, ContactListComponent_th_113_Template, 2, 0, "th", 44)(114, ContactListComponent_td_114_Template, 5, 5, "td", 45);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(115, ContactListComponent_tr_115_Template, 1, 0, "tr", 51)(116, ContactListComponent_tr_116_Template, 1, 0, "tr", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275template(117, ContactListComponent_div_117_Template, 7, 2, "div", 53);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275property("size", 28);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate((ctx.currentUser == null ? null : ctx.currentUser.username) || "Usuario");
    \u0275\u0275advance(3);
    \u0275\u0275property("name", ctx.isDarkTheme ? "sun" : "moon")("size", 20);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx.isDarkTheme ? "OSCURO" : "CLARO", " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx.formatTime(ctx.elapsedTime));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx.contacts.length);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx.getContactsByStatus("NEW"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx.getContactsByStatus("PENDING"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx.getContactsByStatus("CONTACTED"));
    \u0275\u0275advance(3);
    \u0275\u0275property("size", 20);
    \u0275\u0275advance(3);
    \u0275\u0275property("size", 20);
...
(() => {
      ...
      <header class="header">
        <div class="header-left">
          ...
          <div class="header-info">
            <h1>Gesti\xF3n de Cobranza</h1>
            <p class="subtitle">\u{1F4CB} Gesti\xF3n de Contactos</p>
          </div>
          ...
          <mat-tab-group class="filter-tabs">
            <mat-tab label="\u{1F50D} Filtros">
              <div class="tab-content">
                ...
                <div class="section">
                  <h3 class="section-title">\u{1F4CA} Estad\xEDsticas</h3>
                  <div class="stat-item">
            ...
            <div class="table-container">
              <table mat-table [dataSource]="contacts" class="contacts-table">
                ...
                <ng-container matColumnDef="phone">
                  <th mat-header-cell *matHeaderCellDef>Tel\xE9fono</th>
  ...
  `, styles: ['/* angular:styles/component:css;c9d6e56084ecd2d3f057e55d83b75ece4ae943ea1e320e7a6dbf37912afab1da;C:/Users/HP/Documents/Kubito-2.0-v1/cashi-discador-frontend/cashi-discador-frontend/src/app/features/contacts/contact-list.component.ts */\n.contacts-container {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n  background-color: var(--secondary-bg);\n}\n.header {\n  background-color: var(--header-bg);\n  color: var(--text-inverse);\n  padding: 16px 24px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  box-shadow: var(--shadow);\n}\n.header-left {\n  display: flex;\n  align-items: center;\n  gap: 20px;\n}\n.app-icon {\n  background-color: #5da8e8;\n  border-radius: 8px;\n  padding: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.app-icon mat-icon {\n  font-size: 28px;\n  width: 28px;\n  height: 28px;\n  color: white;\n}\n.header-info h1 {\n  margin: 0;\n  font-size: 20px;\n  font-weight: 600;\n}\n.header-info .subtitle {\n  margin: 0;\n  font-size: 12px;\n  opacity: 0.9;\n}\n.advisor-info {\n  display: flex;\n  flex-direction: column;\n  padding-left: 20px;\n  border-left: 1px solid rgba(255, 255, 255, 0.2);\n}\n.advisor-info .label {\n  font-size: 11px;\n  opacity: 0.8;\n}\n.advisor-info .name {\n  font-size: 14px;\n  font-weight: 500;\n}\n.header-right {\n  display: flex;\n  align-items: center;\n  gap: 20px;\n}\n.theme-toggle {\n  background-color: var(--theme-button-bg) !important;\n  color: var(--theme-button-text) !important;\n  font-weight: 600;\n  padding: 0 20px;\n  height: 36px;\n}\n.theme-toggle mat-icon {\n  margin-right: 8px;\n}\n.status-section {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n}\n.status-label {\n  font-size: 11px;\n  opacity: 0.8;\n}\n.status-value {\n  font-size: 14px;\n  font-weight: 600;\n}\n.status-value.available {\n  color: #10b981;\n}\n.timer {\n  font-family: "Courier New", monospace;\n  font-size: 24px;\n  font-weight: 600;\n  padding: 8px 16px;\n  background-color: rgba(0, 0, 0, 0.2);\n  border-radius: 4px;\n}\n.info-bar {\n  background-color: var(--client-bar-bg);\n  border-bottom: 1px solid var(--border-color);\n  padding: 16px 24px;\n  display: flex;\n  align-items: center;\n  gap: 32px;\n  box-shadow: var(--shadow);\n}\n.info-data {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.info-data .label {\n  font-size: 11px;\n  color: var(--text-secondary);\n  text-transform: uppercase;\n}\n.info-data .value {\n  font-size: 14px;\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.action-buttons {\n  margin-left: auto;\n  display: flex;\n  gap: 12px;\n}\n.btn-add {\n  background-color: var(--button-primary) !important;\n  color: white !important;\n  font-weight: 600;\n}\n.btn-back {\n  background-color: var(--button-secondary) !important;\n  color: white !important;\n  font-weight: 600;\n}\n.main-content {\n  flex: 1;\n  display: grid;\n  grid-template-columns: 300px 1fr;\n  gap: 0;\n  min-height: 0;\n}\n.left-panel {\n  background-color: var(--panel-bg);\n  border-right: 1px solid var(--border-color);\n  overflow-y: auto;\n}\n.filter-tabs {\n  height: 100%;\n}\n.tab-content {\n  padding: 20px;\n}\n.section {\n  margin-bottom: 24px;\n}\n.section-title {\n  font-size: 14px;\n  font-weight: 600;\n  color: var(--panel-text);\n  margin-bottom: 12px;\n  padding-bottom: 8px;\n  border-bottom: 1px solid var(--border-color);\n}\n.filter-option {\n  padding: 8px 0;\n}\n.filter-option label {\n  font-size: 13px;\n  color: var(--text-primary);\n  cursor: pointer;\n}\n.stat-item {\n  display: flex;\n  justify-content: space-between;\n  padding: 8px 0;\n  border-bottom: 1px solid var(--border-color);\n}\n.stat-label {\n  font-size: 12px;\n  color: var(--text-secondary);\n}\n.stat-value {\n  font-size: 14px;\n  font-weight: 600;\n  color: var(--panel-text);\n}\n.right-panel {\n  padding: 24px;\n  overflow-y: auto;\n  background-color: var(--primary-bg);\n}\n.list-section {\n  background-color: var(--secondary-bg);\n  border: 1px solid var(--border-color);\n  border-radius: 8px;\n  padding: 20px;\n}\n.section-header {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  margin-bottom: 20px;\n}\n.section-header h3 {\n  margin: 0;\n  font-size: 18px;\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.section-header mat-icon {\n  color: var(--accent-info);\n}\n.table-container {\n  overflow-x: auto;\n}\n.contacts-table {\n  width: 100%;\n  background-color: transparent;\n}\n.contacts-table th {\n  background-color: var(--secondary-bg);\n  color: var(--text-primary);\n  font-weight: 600;\n  font-size: 13px;\n  padding: 12px 16px;\n  border-bottom: 2px solid var(--border-color);\n}\n.contacts-table td {\n  color: var(--text-primary);\n  font-size: 14px;\n  padding: 12px 16px;\n  border-bottom: 1px solid var(--border-color);\n}\n.table-row {\n  transition: background-color 0.2s;\n}\n.table-row:hover {\n  background-color: var(--secondary-bg);\n}\n.status-chip {\n  font-size: 11px;\n  font-weight: 600;\n  padding: 4px 12px;\n  border-radius: 12px;\n}\n.status-chip.new {\n  background-color: #60a5fa;\n  color: white;\n}\n.status-chip.pending {\n  background-color: #fbbf24;\n  color: #1a1a1a;\n}\n.status-chip.contacted {\n  background-color: #10b981;\n  color: white;\n}\n.status-chip.failed {\n  background-color: #dc3545;\n  color: white;\n}\n.action-btn {\n  color: var(--text-secondary);\n  transition: color 0.2s;\n}\n.action-btn:hover {\n  color: var(--accent-info);\n}\n.call-btn:hover {\n  color: var(--button-primary);\n}\n.no-data {\n  text-align: center;\n  padding: 60px 20px;\n  color: var(--text-secondary);\n}\n.no-data mat-icon {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  opacity: 0.3;\n  margin-bottom: 16px;\n}\n.no-data p {\n  font-size: 16px;\n  margin-bottom: 20px;\n}\n@media (max-width: 1024px) {\n  .main-content {\n    grid-template-columns: 1fr;\n  }\n  .left-panel {\n    max-height: 300px;\n  }\n}\n/*# sourceMappingURL=contact-list.component.css.map */\n'] }]
  }], () => [{ type: ContactService }, { type: AuthService }, { type: ThemeService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactListComponent, { className: "ContactListComponent", filePath: "src/app/features/contacts/contact-list.component.ts", lineNumber: 580 });
})();
export {
  ContactListComponent
};
//# sourceMappingURL=chunk-J7MIFE4S.js.map
