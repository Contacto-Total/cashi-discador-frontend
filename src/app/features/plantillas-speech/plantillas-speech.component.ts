...
interface CriterioSpeech {
  ...
  /**
   * Los tres los devuelve el backend y se reenvían tal cual al guardar: la
   * pantalla ya no los edita —la redacción vive en el prompt del analyzer—
   * pero recortarlos del payload los borraría en la BD.
   */
          ...
          <div class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-800">
              ...
              <p class="mt-2 text-xs text-gray-500">
                La redacción de cada criterio es fija. Desde acá se elige qué se evalúa
                en esta subcartera, no cómo se evalúa.
              </p>
