...
@Component({
  selector: 'app-add-to-blacklist-form',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, CustomSelectComponent],
  templateUrl: './add-to-blacklist-form.component.html',
  styleUrls: ['./add-to-blacklist-form.component.css']
})
export class AddToBlacklistFormComponent implements OnInit {
