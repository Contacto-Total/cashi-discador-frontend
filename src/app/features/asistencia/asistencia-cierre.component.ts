...
import { HorarioSemanaComponent } from './horario-semana.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, LucideAngularModule, HorarioSemanaComponent],
  styles: [`
    :host { display: block; }
  ...
  template: `
      ...
      <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p class="mt-[3px] text-[12.5px] text-[#5f6c80] dark:text-slate-400">
            Se cierra el lunes siguiente; hasta entonces entran solicitudes y correcciones
          </p>
        </div>
    ...
    <div class="aparecer">
      ...
      <div class="mb-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div [class]="estilos.tarjeta">
          <div class="mb-2 flex items-center gap-2.5">
            ...
            <h3 [class]="estilos.rotulo">Solicitudes</h3>
          </div>
      ...
      <!-- El horario de la semana que se cierra: el fijo del equipo con lo que cambian las solicitudes -->
      @if (idSubcartera()) {
        <app-horario-semana [idSubcartera]="idSubcartera()" [lunes]="lunes()" (modificar)="modificarHorario.emit()" />
      }
        ...
        <table class="w-full border-collapse">
          ...
          <thead class="border-b border-[#e6e9ee] dark:border-slate-800">
            <tr>
              ...
              <th scope="col" [class]="estilos.th">Recuperación</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr class="border-b border-[#f1f3f6] last:border-0 dark:border-slate-800"
                ...
                <td [class]="estilos.td + ' !whitespace-normal'">
                  @if (r.programada) {
                    ...
                    <span class="text-[#8491a3] dark:text-slate-500">Sin solicitud</span>
                  }
                </td>
              </tr>
            } @empty {
...
export class AsistenciaCierreComponent {
  ...
  /** Ir a Configuración › Horarios: el horario fijo solo se cambia ahí. */
  readonly modificarHorario = output<void>();
  ...
  readonly bloqueo = computed(() => {
    ...
    if (this.incompletos() || this.sinResolver()) {
      return 'Faltan marcas por completar o solicitudes por resolver';
    }
    return null;
  });
