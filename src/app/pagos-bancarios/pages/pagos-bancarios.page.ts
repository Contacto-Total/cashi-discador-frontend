    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 p-6">
      ...
      <div class="mb-6 flex items-start justify-between">
        ...
        <a
          ...
          class="inline-flex items-center gap-3 rounded-xl bg-amber-500 px-6 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
        >
